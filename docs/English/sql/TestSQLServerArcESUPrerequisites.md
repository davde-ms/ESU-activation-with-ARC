...
Run [CheckSQLServerESUStatus.kql](../../../samples/CheckSQLServerESUStatus.kql) in Azure Resource Graph Explorer and download the result as CSV, or use the same structure as the status sample.
